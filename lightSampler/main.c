...
int main(){
  ...
  // }
  // writeI2cReg(i2cFileDesc, 0x00, 0x80);
  // writeI2cReg(i2cFileDesc, 0x02, 0x54);
  // writeI2cReg(i2cFileDesc, 0x04, 0x54);
  // writeI2cReg(i2cFileDesc, 0x06, 0x57);
  // writeI2cReg(i2cFileDesc, 0x08, 0x54);
  // writeI2cReg(i2cFileDesc, 0x0A, 0x54); 
  // writeI2cReg(i2cFileDesc, 0x0C, 0x23);
  // writeI2cReg(i2cFileDesc, 0x0E, 0x08);
  displayDouble(1.1);
  //displayInteger(11);
  //displayInt();
